...
public class MyCustomReceiver extends BroadcastReceiver {
    ...
    private void processPush(Context context, Intent intent) {
        ...
        if (action.equals(intentAction)) {
            ...
            try {
                ...
                if(planId!=null && nameSender!=null){
                    // create a local notification
                    createNotification(context, planId,nameSender);
                }
    ...
    private void createNotification(Context context, String planId,String nameSender) {
        ...
        String title = nameSender+" made a plan";
